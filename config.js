...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Adonai construction Pty Ltd",
    phone:     "+27 60 689 0541",
    whatsapp:  "+27 60 689 0541",
    address:   "7 Plunkett Ave, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Adonai construction Pty Ltd — Building & construction in Johannesburg",
    description: "Adonai construction Pty Ltd provides professional building and construction services in Johannesburg — new builds, extensions and renovations. 8 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "Adonai construction Pty Ltd handles new builds, extensions, renovations and structural work for homes and businesses across Johannesburg. Clear quotes, quality workmanship and projects finished on time.",

    googleRating: "3.9",
    reviewsCount: "8",
    featuredQuote: "They built our double-storey extension from foundation to finish. On budget, properly project-managed and the workmanship is excellent.",
    ...
    band: {
      ...
      alt:   "Adonai construction Pty Ltd team on a building site in Johannesburg",
    ...
    reviews: [
      {
        body:   "They built our double-storey extension from foundation to finish. On budget, properly project-managed and the workmanship is excellent.",
        name:   "Thabo M.",
        stars:  5,
        source: "Google"
      },
      {
        body:   "Renovated our whole kitchen and added a room. Clear quote, tidy site and they finished when they said they would.",
        name:   "Sandra K.",
        stars:  5,
        source: "Google"
      },
      {
        body:   "Reliable construction team that actually shows up and manages the job. Quality work and honest pricing throughout.",
        name:   "Pieter V.",
        stars:  4,
        source: "Google"
      },
